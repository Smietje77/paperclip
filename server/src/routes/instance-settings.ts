...
import { companyAdapterSettingsService, instanceSettingsService, logActivity } from "../services/index.js";
...
export function instanceSettingsRoutes(db: Db) {
  ...
  router.get("/instance/adapter-usage", async (req, res) => {
    assertCanManageInstanceSettings(req);
    res.json(await adapterSettings.instanceUsage());
  });
